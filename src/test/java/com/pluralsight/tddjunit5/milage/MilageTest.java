...
class MilageTest {
    ...
    @ParameterizedTest//CSV Format ->contains , in order; the flight number, its type, the name of the passenger, if he's a VIP or not, and the mileage of that flight.
    @Disabled
